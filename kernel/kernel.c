...
#error "You are no using a cross-compiler, you will most certainly run into trouble"
#endif
...
void terminal_putchar(char c)
{
        if (c == '\n') {
                ...
                if (++terminal_row == VGA_HEIGHT) {
                        terminal_row = VGA_HEIGHT - 1;  // Stay at bottom
                        terminal_scroll();               // Scroll up
                }
                return;
        }
...
void kernel_main(void)
{
        ...
        // Print 30 lines to test scrolling
        ...
        terminal_writestring("Line 26 - SCROLLING!\n");
        terminal_writestring("Line 27 - SCROLLING!\n");
        terminal_writestring("Line 28 - SCROLLING!\n");
        terminal_writestring("Line 29 - SCROLLING!\n");
        terminal_writestring("Line 30 - SCROLLING!\n");
}
